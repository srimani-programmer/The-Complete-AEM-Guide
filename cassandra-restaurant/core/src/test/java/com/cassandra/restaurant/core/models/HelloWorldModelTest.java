 ...
 */
package com.cassandra.restaurant.core.models;
...
import com.cassandra.restaurant.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "cassandra/components/helloworld");
