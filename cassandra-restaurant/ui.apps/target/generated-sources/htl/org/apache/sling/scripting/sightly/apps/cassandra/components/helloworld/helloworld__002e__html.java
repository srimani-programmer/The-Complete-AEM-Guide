 ...
 * under the License.
 ******************************************************************************/
package org.apache.sling.scripting.sightly.apps.cassandra.components.helloworld;
...
out.write("\r\n    ");
_global_model = renderContext.call("use", com.cassandra.restaurant.core.models.HelloWorldModel.class.getName(), obj());
{
